...
if (!isset($_SESSION['admin_email'])) {
    ...
    if (isset($_GET['edit_store'])) {
        ...
        $store_map = $row_store['store_map']; // Nuevo campo store_map
                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                ...
                                <br>
                                <img src="store_images/<?php echo $store_image; ?>" width="70" height="70" alt="">
                            </div>
                        </div>
                        <!-- form-group Ends -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <textarea name="store_desc" class="form-control" rows="10" cols="19"><?php echo $store_desc; ?></textarea>
                            </div>
                        </div>
                        <!-- form-group Ends -->
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-md-3 control-label"> store Description : </label>
                            <div class="col-md-6">
                                <textarea name="store_map" class="form-control" rows="10" cols="19"><?php echo $store_map; ?></textarea>
                            </div>
                        </div>
                        <!-- form-group Ends -->
    ...
    if (isset($_POST['update'])) {
        ...
        $store_map = $_POST['store_map']; // Nuevo campo store_map
        ...
        $update_store = "UPDATE store SET store_title='$store_title',store_image='$store_image',store_desc='$store_desc',store_button='$store_button',store_url='$store_url',store_map='$store_map' WHERE store_id='$store_id'";
