...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet" href="bootstrap5/assets/vendor/libs/@form-validation/umd/styles/index.min.css" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="bootstrap5/assets/vendor/css/pages/page-auth.css" />
...
<style>
    .card {
        ...
        padding: 20px;
        background-color: rgba(255, 255, 255, 0.41); /* Color blanco con 70% de opacidad */
        color: #ffffff;
    }

    .container-p-y {
background-image: url('store_images/login1.jpg');
background-size: cover; /* Cubre toda la página sin distorsionar la imagen */
background-position: center; /* Centra la imagen en el fondo */
background-repeat: no-repeat; /* Evita que la imagen se repita */
/* Puedes ajustar otras propiedades según tus preferencias */
}
</style>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-login" action="" method="post" ><!-- form-login Starts -->
                    ...
                    <button class="btn btn-primary d-grid w-100" id="admin_login" name="admin_login" type="submit">Sign in</button>
                </form>
...
<script src="bootstrap5/assets/vendor/libs/node-waves/node-waves.js"></script>
...
<!-- Vendors JS -->
<script src="bootstrap5/assets/vendor/libs/@form-validation/umd/bundle/popular.min.js"></script>
<script src="bootstrap5/assets/vendor/libs/@form-validation/umd/plugin-bootstrap5/index.min.js"></script>
<script src="bootstrap5/assets/vendor/libs/@form-validation/umd/plugin-auto-focus/index.min.js"></script>

<!-- Main JS -->
<script src="bootstrap5/assets/js/main.js"></script>

<!-- Page JS -->
<script src="bootstrap5/assets/js/pages-auth.js"></script>
</body>
</html>
