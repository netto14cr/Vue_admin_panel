...
<?php
include("insert_probun_functions.php");
?>

<div class="card mb-4">
    <h5 class="card-header">Insert Bundle</h5>
    <form class="card-body form-horizontal" method="post" enctype="multipart/form-data">
        ...
        <hr class="my-4 mx-n4">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    <label class="form-label" for="product_title">Manufacturer</label>
        ...
        <hr class="my-4 mx-n4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6" >
                    <br>
                    <button type="submit"  name="submit"  value="Insert Bundle" class="btn btn-primary me-sm-3 me-1 waves-effect waves-light">Insert Bundle</button>
                    <a href="index.php?view_bundles" class="btn btn-danger waves-effect waves-light">Cancel</a>
                </div>
